...
# Train LSTM model
lstm_history = lstm_model.fit(X_train, train_df['label'], epochs=5, batch_size=64, validation_split=0.2, verbose=0)

# Evaluate LSTM model
lstm_evaluation = lstm_model.evaluate(X_test, test_df['label'])
...
# Train CNN model
cnn_history = cnn_model.fit(X_train, train_df['label'], epochs=5, batch_size=64, validation_split=0.2, verbose=0)

# Evaluate CNN model
cnn_evaluation = cnn_model.evaluate(X_test, test_df['label'])
...
# Train GRU model
gru_history = gru_model.fit(X_train, train_df['label'], epochs=5, batch_size=64, validation_split=0.2, verbose=0)

# Evaluate GRU model
gru_evaluation = gru_model.evaluate(X_test, test_df['label'])
